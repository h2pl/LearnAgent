...
- [LLM 的局限与工程对策](./docs/02-llm-basics/05-limitations.md)
...
- [评测体系与指标](./docs/13-eval/01-evaluation-system.md)
- [确定性评测方法](./docs/13-eval/02-deterministic-evaluation.md)
- [LLM-as-Judge：用 LLM 做自动评测](./docs/13-eval/03-llm-as-judge.md)
- [评测驱动开发实践](./docs/13-eval/04-eval-driven-development.md)
- [生产环境评测实践](./docs/13-eval/05-production-evaluation.md)
...
- [Agent 系统架构设计](./docs/16-ship-to-prod/01-architecture.md)
- [API 服务化](./docs/16-ship-to-prod/02-api-service.md)
- [Agent 部署方案](./docs/16-ship-to-prod/03-deployment.md)
- [Agent 运维实战](./docs/16-ship-to-prod/04-operations.md)
