...
这是一套从零开始学 AI Agent 的完整路径。从「Agent 是什么」一路走到「部署上线」，每章解决一个核心问题，前后衔接形成闭环。

不同于只讲一个框架或一个 demo 的教程，这个指南试图覆盖 Agent 开发的完整知识栈：底层原理、核心技能、架构设计、工程交付，层层递进，学完能真正动手做产品。

### 创作动机

网上讲 Agent 的内容不缺，但三个痛点普遍存在：教程太浅，停留在调 API 和跑 demo 的层面；知识太散，每篇文章只讲一个点，拼在一起不成体系；从 demo 到产品之间有一道巨大的鸿沟，很少有人讲怎么跨过去。

这个指南试图一次解决这三个问题：把分散的知识整理成一条完整的学习路线，帮你少走弯路，真正理解 Agent 的全貌。

### 目标读者

写给想系统理解 AI Agent 的人。如果你是开发者，这里能帮你建立完整的 Agent 知识体系，而不只是会用某个框架；如果你是产品经理或技术管理者，这里能帮你理解 Agent 能做什么、不能做什么、怎么做决策；如果你是 AI 爱好者，这里能帮你看清整个领域的全貌和演进方向。
