...
你好，我是江小湖。在 [Agent 核心循环](../05-agent-loop/02-agent-core-loop.md) 中，你已经知道 Agent 每轮都要往上下文里塞东西：系统提示、工具定义、对话历史、工具返回结果……越积越多。但上下文窗口是有限的——128K 到 1M 看起来很大，实践起来处处掣肘。**窗口有限，信息无限**。这篇文章解决核心问题：**上下文窗口的瓶颈在哪里、信息应该怎么排优先级、为什么窗口不是越大越好**。
