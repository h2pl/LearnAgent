...
你好，我是江小湖。[主流模型对比与选型](./01-model-comparison.md)讲了不同厂商之间的横向对比。[LLM API 调用实战](./02-api-calling.md)让你已经能跑通第一个 `hello world` 了。但实际开发中你还会遇到另一个问题：**同一个厂商的模型有好几个版本**——Claude 有 Haiku、Sonnet、Opus，GPT 有 4o-mini 和 4o，DeepSeek 有 V4-Flash 和 V4-Pro。
