...
- **特点**：价格只有 Tier 1 的五分之一，但在推理、代码生成上能达到 80%-90% 的水平。DeepSeek V4-Pro 在 SWE-bench 上达到 80.6%，且价格极低（$0.435/百万输入）。Qwen 3.7 Max 的 GPQA 高达 92.4%（甚至超过部分 Tier 1）。Kimi K2.6 是开源模型之王（GPQA 90.5%，Code Arena 1550）。MiniMax M3 是极致性价比之选（MIT 开源，$0.60 输入，SWE-Bench Pro 59.0%）。
...
| DeepSeek V4-Pro（开源） | $0.435 | $0.87 | 14 | 推理特化 |
| Qwen 3.7 Max（阿里） | $1.25 | $3.75 | 39 | 极致性价比 |
| Kimi K2.6（月之暗面，开源） | $0.95 | $4.00 | 38 | 开源之王 |
| MiniMax M3（稀宇科技，开源） | $0.60 | $2.40 | 119 | 极致性价比 |
