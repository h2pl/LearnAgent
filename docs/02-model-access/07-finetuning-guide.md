...
<img src="../../assets/02-model-access/finetuning-decision-flow.svg" alt="微调 vs Prompt vs RAG 决策流程图，展示从问题诊断到方案选择的逐级升级路径" width="600"/>
...
<img src="../../assets/02-model-access/lora-architecture.svg" alt="LoRA 低成本微调原理图：全量微调 vs LoRA 的参数对比、显存需求和成本对比" width="600"/>
