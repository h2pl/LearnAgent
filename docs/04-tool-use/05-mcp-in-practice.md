...
<p align="center">
  <img src="../../assets/04-tool-use/mcp-inspector.svg" alt="MCP Inspector 调试界面：工具/资源/提示的交互式测试" width="95%"/>
</p>
...
> 恭喜你，工具调用全部掌握。接下来，Agent 怎么知道"什么时候该做什么事"？怎么自主规划多步任务？请继续阅读 [05 — Agent 循环](../05-agent-loop/README.md)，了解 Agent 的核心架构。
