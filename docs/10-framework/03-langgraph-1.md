...
但真实的 Agent 工作流很少是直线的。回顾在 [从零实现最小 Agent](../06-agent-loop/08-minimal-agent.md) 中构建的 ReAct 循环：
...
<p align="center">
  <img src="../../assets/10-framework/linear-vs-stategraph.svg" alt="LCEL 线性管道与 LangGraph 状态图对比" width="90%"/>
  <br/>
...
<p align="center">
  <img src="../../assets/10-framework/react-agent-graph.svg" alt="ReAct Agent 状态图结构" width="70%"/>
  <br/>
