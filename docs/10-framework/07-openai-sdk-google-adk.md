...
<p align="center"><img src="../../assets/10-framework/sdk-adk-comparison.svg" alt="OpenAI SDK vs Google ADK对比" width="90%"/><br/><em>图：OpenAI Agents SDK 与 Google ADK 全方位对比</em></p>
...
<div align="center">
<img src="../../assets/10-framework/handoff-and-a2a.svg" alt="Handoff 模式与 A2A 协议" width="90%"/>
</div>
...
> 下一篇：[扩展协议全景](../11-protocols/01-protocol-landscape.md) —— 看看 MCP、Skills、A2A 这些协议如何连接 Agent 生态。
