...
[扩展协议](../10-protocols/01-protocol-landscape.md) 一章教会了你 Agent 之间怎么通信（A2A 协议）。本章解决更本质的问题：**系统该怎么拆、角色该怎么分、拆了之后怎么管**。多 Agent 不是技术问题，是架构问题。
...
> 学完本章后，请继续阅读 [12 — 评估与追踪](../12-eval-trace/README.md)，学习如何评估你的 Agent 系统质量。
