...
<p align="center">
  <img src="../../assets/11-multi-agent/multi-agent-evolution.svg" alt="从单体 Agent 到多 Agent 的演进路径" width="95%"/>
</p>
...
> 学完 11 章，你已经掌握了多 Agent 系统的设计、开发和运维。下一章 [12 — 评估与追踪](../12-eval-trace/README.md)——你的系统做出来了，但怎么知道它好不好？
