...
<p align="center">
  <img src="../../assets/03-prompt-engineering/prompt-iteration-loop.png" alt="Prompt 迭代闭环" width="90%"/>
  <br/>
...
<p align="center">
  <img src="../../assets/03-prompt-engineering/llm-as-judge-pipeline.png" alt="LLM-as-Judge 评估流水线" width="90%"/>
  <br/>
...
> Prompt 工程的"内功"已成，下一步是"招式"——让 LLM 不只生成文本，而是能执行真实操作。下一章进入 [04 — 工具调用](../04-tool-use/README.md)，学习 Agent 的"动手能力"。
