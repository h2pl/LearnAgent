...
你好，我是江湖哥。上一篇讲了四种 Prompt 设计模式，掌握了"怎么问"。这一篇解决一个更具体的问题：模型答了，但代码怎么消费它的回答？答案就四个字——结构化输出。
...
- **可选字段用 None**：`str | None` 让模型知道这个字段可以留空
...
<p align="center">
  <img src="../../assets/03-prompt-engineering/parsing-defense.png" alt="三层解析防御策略" width="90%"/>
  <br/>
