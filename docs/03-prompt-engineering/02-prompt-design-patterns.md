...
你好，我是江湖哥。前两章搞懂了 LLM 是什么、怎么接入，现在到了最关键的一步——怎么组织你的指令，让模型产出你真正想要的结果。这四种模式，就是 Prompt 工程的"语法"。
...
<p align="center">
  <img src="../../assets/03-prompt-engineering/pattern-progression.png" alt="四种模式递进关系" width="90%"/>
  <br/>
...
<p align="center">
  <img src="../../assets/03-prompt-engineering/cot-comparison.png" alt="标准回答 vs CoT 对比" width="90%"/>
  <br/>
...
- **放在 System Prompt 中**：不要把角色定义放在 User 对话里，应该放在 System Prompt 中（下一篇文章会专门讲 System Prompt 的设计）

**角色设定 vs System Prompt**：角色设定是一种 Prompt 模式，System Prompt 是实现它的最佳载体。你可以把角色设定看作是"设计"，把 System Prompt 看作是"实现"。下一篇文章会展开 System Prompt 的结构化设计方法。
...
<p align="center">
  <img src="../../assets/03-prompt-engineering/pattern-combo.png" alt="模式组合示例" width="90%"/>
  <br/>
  <em>四种模式的典型组合方式</em>
</p>
