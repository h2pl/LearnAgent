...
**Prompt 工程的本质：通过精心设计输入，引导 LLM 的概率分布朝你想要的方向偏移。** 不是"求"模型做好，而是给它足够的信号，让它"不得不"做好。你在 API 调用中设置的 `temperature`、`max_tokens` 等参数（详见[关键参数与调优](../02-model-access/02-key-parameters.md)）控制的是生成过程的随机性和长度，而 Prompt 控制的是**内容方向**——两者配合使用，才能精确控制输出。
...
<p align="center">
  <img src="../../assets/03-prompt-engineering/message-roles.svg" alt="三种消息角色与LLM交互流程" width="90%"/>
  <br/>
...
<p align="center">
  <img src="../../assets/03-prompt-engineering/attention-distribution.svg" alt="LLM注意力分布" width="90%"/>
  <br/>
