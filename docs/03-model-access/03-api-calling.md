...
> **模型跑在哪里？** 这是另一个问题。大多数情况下你会先调云端 API 快速原型；如果数据不能出内网或成本太高，再考虑[模型本地部署实战](./06-local-deployment.md)。无论模型跑在哪，底层都是 HTTP 请求到某个端点——区别只在于你用什么方式发这个请求。
...
<p align="center">
  <img src="../../assets/03-model-access/api-streaming-flow.png" alt="流式输出时序图" width="90%"/>
  <br/>
...
<p align="center">
  <img src="../../assets/03-model-access/api-call-flow.png" alt="API 调用流程" width="90%"/>
  <br/>
...
> 代码调通了，参数也理解了，接下来看看模型生态中各种变体——Base、Chat、Code、Reasoning 到底怎么选。请前往 [模型变体速查](./04-model-variants-landscape.md)。
