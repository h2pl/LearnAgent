...
<img src="../../assets/03-model-access/context-window-comparison.png" alt="主流模型上下文窗口对比图，从 32K 到 1M tokens 的可视化对比" width="600"/>
...
<img src="../../assets/03-model-access/model-cost-comparison.png" alt="OpenAI API 价格趋势图，展示从 GPT-4 到 GPT-5.5 的每百万 Token 价格变化" width="600"/>
...
<img src="../../assets/03-model-access/model-selection-decision.png" alt="模型选型决策流程图：从原型验证到开发优化到生产部署的三阶段选型路径" width="600"/>
...
> 选好了模型，接下来先搞懂 API 上的几个关键参数。请前往 [关键参数与调优](./02-key-parameters-and-tuning.md)。
