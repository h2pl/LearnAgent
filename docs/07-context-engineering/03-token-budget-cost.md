...
<p align="center">
  <img src="../../assets/07-context-engineering/token-budget-allocation.svg" alt="Token预算分配图" width="90%"/>
  <br/>
...
<p align="center">
  <img src="../../assets/07-context-engineering/cost-vs-accuracy.svg" alt="上下文长度vs准确率vs成本" width="90%"/>
  <br/>
...
> 预算只是控制成本的手段，更高级的策略是"不该在上下文里的东西就不让它进窗口"。请继续阅读 [上下文卸载与隔离](./04-context-offloading-isolation.md)，学习文件系统当外存、主子 Agent 分离等进阶技巧。
