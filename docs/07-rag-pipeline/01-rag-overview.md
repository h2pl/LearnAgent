...
你好，我是江小湖。在 [上下文工程](../06-context-engineering/README.md) 中，你已经知道了一个核心约束：上下文窗口有限，不能什么都往里塞。那外部知识怎么办？不塞全部，按需检索——**这是 RAG 的第一个价值**。但 RAG 不止于此：LLM 的训练数据总有截止日期，你的私有文档、公司知识库、最新的技术文档，模型根本没见过。**RAG 的第二个价值是给模型补充它不知道的知识**——让 LLM 基于你的私有知识库回答问题，而不是靠它训练时记住的过时信息。
...
<p align="center">
  <img src="../../assets/07-rag-pipeline/rag-full-architecture.svg" alt="RAG系统完整架构：离线索引+在线检索+LLM生成，端到端流程" width="95%"/>
</p>
