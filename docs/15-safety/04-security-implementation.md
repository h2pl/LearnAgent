...
<p align="center">
  <img src="../../assets/15-safety/security-middleware-pipeline.svg" alt="安全中间件管道架构：输入检测→权限网关→Agent逻辑→输出过滤" width="95%"/>
</p>
...
<p align="center">
  <img src="../../assets/15-safety/security-eval-pipeline.svg" alt="安全评测流水线：对抗用例库→安全中间件→评测报告→CI/CD 门禁" width="95%"/>
</p>
...
**下一篇**：[Agent 系统架构设计](../16-ship-to-production/01-architecture.md)——从安全转向产品交付。
