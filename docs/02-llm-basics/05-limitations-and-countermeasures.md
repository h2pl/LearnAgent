...
> [LLM 核心能力](./04-capabilities.md)讲了 LLM 能做什么，这篇反过来看——它**做不到什么**、为什么做不到、工程上怎么应对。每个局限都有明确的架构根因，理解了根因，你才能对症下药，而不是盲目地改 Prompt 或微调。
...
<p align="center">
  <img src="../../assets/02-llm-basics/autoregressive-generation.png" alt="自回归模型逐 Token 生成" width="90%"/>
  <br/>
...
<p align="center">
  <img src="../../assets/02-llm-basics/rag-pipeline.png" alt="RAG 检索增强生成工作流程" width="90%"/>
  <br/>
