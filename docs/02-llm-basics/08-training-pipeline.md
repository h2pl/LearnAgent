...
<p align="center">
  <img src="../../assets/02-llm-basics/rlhf-pipeline.png" alt="RLHF 训练流程" width="90%"/>
  <br/>
...
<p align="center">
  <img src="../../assets/02-llm-basics/lora-architecture.png" alt="LoRA 低秩适配原理" width="90%"/>
  <br/>
...
> 至此，【01 — LLM 基础】全部完成。从能力边界、Token 机制、Transformer 内部原理到训练流程，你已经建立了完整的认知基础。接下来进入实战，看看如何选择模型并在代码中调用它们。请阅读 [02 — 模型接入](../03-model-access/README.md)。
