...
你好，我是江小湖。在 [工具调用](../05-tool-use/01-tool-calling-mechanism.md) 中，你学会了让 LLM 突破文本边界。但"能调用工具"只是 Agent 的一个特征，真正的 Agent 还需要自主决策能力。这篇文章帮你厘清三种形态的本质区别：**什么场景用 Chatbot 就够，什么场景必须上 Agent**。
...
<p align="center">
  <img src="../../assets/06-agent-loop/three-forms-comparison.png" alt="三种应用形态对比" width="95%"/>
  <br/>
...
<p align="center">
  <img src="../../assets/06-agent-loop/decision-power-diagram.png" alt="决策权归属示意" width="85%"/>
  <br/>
