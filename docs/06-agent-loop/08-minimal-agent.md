...
你好，我是江小湖。在 [Agent 停止条件设计](./07-stop-conditions.md) 中，你学会了让 Agent 安全停止。现在是时候把所有知识串起来——**从零实现一个最小 Agent**，不依赖 LangChain 或任何框架，纯代码实现 ReAct 循环。
...
<p align="center">
  <img src="../../assets/06-agent-loop/minimal-agent-architecture.png" alt="最小 Agent 架构" width="95%"/>
  <br/>
...
<p align="center">
  <img src="../../assets/06-agent-loop/minimal-vs-production.png" alt="最小 Agent vs 生产系统" width="95%"/>
  <br/>
