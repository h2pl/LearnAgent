...
你好，我是江小湖。从 [Agent 框架概述与选型](../09-framework/01-framework-overview.md) 到 [多 Agent 架构模式](../11-multi-agent/01-architecture-patterns.md)，前面的章节一直在学怎么"造"Agent。但到了生产阶段，你会发现最缺的不是"怎么做得更好"，而是**"怎么知道它好不好"**。
...
<p align="center">
  <img src="../../assets/12-eval/eval-method-spectrum.svg" alt="评测方法谱系" width="95%"/>
</p>
