...
你好，我是江小湖。前两篇讲了架构模式和角色设计，但纸上得来终觉浅——本文用 **CrewAI** 框架搭建一个真实的"研究团队"多 Agent 系统。CrewAI 在 [CrewAI 详解](../10-framework/05-crewai.md) 中已经做过概览，本文深入实战。

## 前置阅读

本文假设你了解 CrewAI 的基本概念（Agent、Task、Crew、Process）。如果不熟悉，建议先看 [CrewAI 详解](../10-framework/05-crewai.md) 前两节。
...
<p align="center">
  <img src="../../assets/12-multi-agent/crewai-components-relationship.svg" alt="CrewAI 核心组件关系：Agent、Task、Crew、Process 的绑定关系" width="90%"/>
...
<div align="center">
  <img src="../../assets/12-multi-agent/crewai-execution-flow.svg" alt="CrewAI 执行流程：三个 Agent 按顺序协作" width="95%"/>
</div>
