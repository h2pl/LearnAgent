...
| 章节 | 文章 | 内容 |
|------|------|------|
| 01 多模态基础 | [什么是多模态](./01-multimodal-fundamentals/01-what-is-multimodal.md) | 概念、单模态 vs 多模态、成熟的三个转折点 |
| | [为什么需要多模态](./01-multimodal-fundamentals/02-why-multimodal.md) | 流水线方案的三大问题、原生方案的优势 |
