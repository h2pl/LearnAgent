...
模型演进 → 商业模型对比 → 视频理解 → 文档与 UI → 实战优化。

## 文章总览

| 文章 | 内容 |
|------|------|
| [VLM 演进：从 CLIP 到 LLaVA](./01-vlm-evolution.md) | 对比学习 → Q-Former → 开源多模态对话的成熟之路 |
| [闭源旗舰：GPT-4o / Gemini / Claude](./02-commercial-vlms.md) | 2026 年三大商业模型的视觉能力对比与选型 |
| [视频理解](./03-video-understanding.md) | 帧采样策略、时序推理、长视频处理 |
