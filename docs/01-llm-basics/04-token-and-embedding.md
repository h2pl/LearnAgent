...
[上一篇](./03-llm-evolution.md)我们回顾了 LLM 从 2018 到 Agent 时代的整个演进史。这一篇我们从最微观的视角切入——LLM 在处理文字时，看到的东西根本不是"字"或"词"，而是 **Token**。

理解 Token 和 Embedding 是理解 LLM 所有后续概念的基础：
...
- **Token**：LLM 处理文本的最小单位，影响成本、上下文窗口和性能。中 1 文 ≈ 1-2 tokens，英文 ≈ 0.75 个词 / token。
