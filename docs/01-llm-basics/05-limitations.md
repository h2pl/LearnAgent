...
<p align="center">
  <img src="../../assets/01-llm-basics/autoregressive.png" alt="自回归生成过程" width="90%"/>
  <br/>
  <em>自回归生成：每一步都从概率分布中采样下一个 Token。当训练数据中没有对应事实时，模型会选择概率最高的续写——看起来合理，但可能是编造的</em>
</p>
...
<p align="center">
  <img src="../../assets/01-llm-basics/rag-workflow.png" alt="RAG 工作流程" width="90%"/>
  <br/>
  <em>RAG 工作流程：离线索引（文档→向量数据库）→ 在线检索（问题编码为向量，搜索最相关的文档块）→ 生成（检索结果 + 原始问题一起输入 LLM）</em>
</p>
