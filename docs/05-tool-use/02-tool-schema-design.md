...
<img src="../../assets/05-tool-use/tool-schema-design.svg" alt="工具 Schema 设计对比：模糊描述 vs 精确描述" width="95%"/>
...
<p align="center">
  <img src="../../assets/05-tool-use/tool-selection-routing.svg" alt="工具选择路由：LLM基于语义匹配度计算各工具概率分布，最高概率的工具被选中" width="95%"/>
</p>
