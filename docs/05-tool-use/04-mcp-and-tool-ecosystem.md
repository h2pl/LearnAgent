...
<img src="../../assets/05-tool-use/mcp-architecture.svg" alt="MCP 协议架构：Host→Client→Server→外部工具，三大原语" width="95%"/>
...
<p align="center">
  <img src="../../assets/05-tool-use/mcp-protocol-layers.svg" alt="MCP协议分层：应用层、协议层、传输层、安全层——N×M变N+M" width="95%"/>
</p>
