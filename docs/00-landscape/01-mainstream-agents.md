...
你好，我是江小湖。这是本系列的第一篇文章。在动手构建 Agent 之前，先看清 2026 年的生态全貌——市场上有什么、怎么分类、怎么选。
...
<img src="../../assets/00-landscape/landscape-map.png" alt="2026 AI Agent 全景图" width="100%"/>
...
<p align="center"><img src="../../assets/00-landscape/agent-classification-matrix.svg" alt="Agent品类能力级分类矩阵" width="90%"/><br/><em>图：7大品类 × 5级能力 双维分类矩阵</em></p>
...
接下来深入最成熟的品类——[Claude Code 编程 Agent](./02-claude-code.md)。
