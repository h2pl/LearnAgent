...
你好，我是江小湖。[评测体系与指标](../13-evaluation/01-evaluation-system.md) 解决了"怎么评测 Agent"和"评测什么指标"的问题。但评测只告诉你"好不好"，不告诉你"为什么不好"。
...
<p align="center">
  <img src="../../assets/14-observability/o11y-pillars.svg" alt="可观测性三支柱在 Agent 系统中的优先级" width="95%"/>
</p>
...
<p align="center">
  <img src="../../assets/14-observability/unified-trace-model.svg" alt="统一追踪数据模型：Episode → Steps 层次结构与关键字段" width="95%"/>
</p>
