...
你好，我是江小湖。[上一篇文章《可观测性设计原则》](01-observability-principles.md) 规划了 Agent 可观测性的设计原则和工具选型。本文把这些原则翻译成代码——从装饰器插桩到 Span 设计到采样配置，覆盖一个生产级追踪系统的全部实现细节。
...
<p align="center">
  <img src="../../assets/14-observability/trace-hierarchy.svg" alt="Trace 三层层次结构" width="95%"/>
</p>
...
<p align="center">
  <img src="../../assets/14-observability/trace-architecture.svg" alt="全链路追踪架构：从用户请求到 Span 链路到存储与可视化" width="95%"/>
</p>
