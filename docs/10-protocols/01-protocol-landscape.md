...
你好，我是江小湖。从 [工具调用](../04-tool-use/01-tool-calling-mechanism.md) 到 [框架编排](../09-framework/01-framework-overview.md)，你的 Agent 已经具备了完整的执行能力。但这里有一个隐性问题：所有工具和交互都绑定在特定的模型和实现上——换个客户端就得重写集成，换个厂商就得重新适配。
...
<p align="center">
  <img src="../../assets/10-protocols/protocol-fragmentation.svg" alt="无协议时的 Agent 孤岛困境" width="90%"/>
</p>
...
<p align="center">
  <img src="../../assets/10-protocols/protocol-layers.svg" alt="Agent 协议分层模型：垂直层、水平层、交互层、商业层" width="90%"/>
</p>
...
实现细节在 [MCP 与工具生态](../04-tool-use/04-mcp-and-tool-ecosystem.md) 中已有详细讲解，本章不再重复。第 02 篇会从协议治理和企业部署的角度做深入分析。
...
<p align="center">
  <img src="../../assets/10-protocols/protocol-interaction-layer.svg" alt="AG-UI 让 Agent 输出与前端解耦" width="90%"/>
</p>
...
<p align="center">
  <img src="../../assets/10-protocols/protocol-landscape-2026.svg" alt="2026 年 Agent 协议全景格局" width="90%"/>
</p>
