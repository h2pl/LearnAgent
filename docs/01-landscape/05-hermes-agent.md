...
你好，我是江小湖。在[2026 主流 Agent 全景](./02-mainstream-agents.md)中你看到了个人助理这个品类。Hermes Agent 是 Nous Research 开发的开源产品（2026 年 2 月发布），和 OpenClaw 定位类似但有一个关键差异：**它会自己成长**。
...
<img src="../../assets/01-landscape/hermes-dashboard.png" alt="Hermes Agent Dashboard 管理界面" width="100%"/>
...
<p align="center"><img src="../../assets/01-landscape/hermes-learning-loop.svg" alt="Hermes闭环学习机制" width="90%"/><br/><em>图：Hermes 四步闭环学习——越用越强的自成长机制</em></p>
